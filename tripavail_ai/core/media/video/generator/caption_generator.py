...
class CaptionGenerator:
    ...
    def __init__(self):
        ...
        self.bottom_margin_ratio = 0.18  # Raise captions ~18% from bottom by default
        self.min_y_offset = 200  # Minimum pixel offset to stay above platform overlays
    ...
    def create_caption_clip(
        ...
        try:
            ...
            if self.position == "top":
                ...
                bottom_margin = max(
                    int(video_size[1] * self.bottom_margin_ratio),
                    self.min_y_offset
                )
