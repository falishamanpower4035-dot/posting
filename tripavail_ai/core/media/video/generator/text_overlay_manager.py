...
class TextOverlayManager:
    ...
    def __init__(self):
        ...
        # Keep subtitles clear of platform overlays (≈15-20% from bottom)
        self.subtitle_bottom_margin_ratio = 0.18
        self.subtitle_bottom_margin_min = 200
    ...
    def create_subtitle_overlays(
        ...
        try:
            for subtitle in subtitle_data:
                ...
                # Position at bottom center with additional clearance from platform UI
                bottom_margin = max(
                    int(video_size[1] * self.subtitle_bottom_margin_ratio),
                    self.subtitle_bottom_margin_min
                )
                txt_clip = txt_clip.with_position(("center", video_size[1] - bottom_margin))
