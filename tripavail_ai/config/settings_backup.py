...
# Email / Notifications
# ========================================
EMAIL_ENABLED = os.getenv(" EMAIL_ENABLED, 1) in (1, 	rue, True)
EMAIL_METHOD = os.getenv(EMAIL_METHOD, gmail_api) # 'smtp' or 'gmail_api'
SMTP_HOST = os.getenv("SMTP_HOST", "smtp.gmail.com")
SMTP_PORT = int(os.getenv("SMTP_PORT", "465"))
SMTP_USER = os.getenv("SMTP_USER", "tripavail92@gmail.com")
SMTP_PASSWORD = os.getenv("SMTP_PASSWORD", "")  # Set Gmail App Password
NOTIFY_EMAIL = os.getenv(NOTIFY_EMAIL, holywolf92@gmail.com)
GMAIL_CLIENT_SECRET_FILE = os.getenv(GMAIL_CLIENT_SECRET_FILE, ient_secret.json)
