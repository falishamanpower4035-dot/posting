...
class TourismEditor:
    ...
    def __init__(self):
        ...
        # Configure logging
        logger.add(self.editor_log_file, level="INFO", rotation="1 day")
    ...
    def create_analysis_prompt(self, articles: List[Dict]) -> str:
        ...
        # OPTIMIZATION: Truncate descriptions to 500 chars to reduce token usage (~60-70% reduction)
        articles_text = ""
        for i, article in enumerate(articles, 1):
            title = article.get('title', 'N/A')
            description = article.get('description', 'N/A')
            
            # Truncate description to first 500 characters to save tokens
            # Title + first 500 chars is sufficient for tourism relevance analysis
...
Please analyze these articles and return ONLY stories with scores above 6 (7-10), ranked by importance and relevance. Reject any stories that would score 6 or below."""
